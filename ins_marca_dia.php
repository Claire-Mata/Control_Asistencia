...
if(mysqli_num_rows($sql1)> 0){
	...
	if($marca=='E'){
		...
		$update1 = mysqli_query($con, "UPDATE empleados SET activo='1' WHERE codigo='$codigo'") or die(mysqli_error());
	...
	if($marca=='S'){
		...
		$update1 = mysqli_query($con, "UPDATE empleados SET activo='0' WHERE codigo='$codigo'") or die(mysqli_error());
